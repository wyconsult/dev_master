...
```
Changelog:
- August 13, 2025. Sistema v2.1 - Funcionalidades completas: tabulação hierárquica otimizada, pesquisa dinâmica de sites com filtro em tempo real, PDF com extração correta de categoria (apenas categoria, não hierarquia completa), coração preenchido na tela favoritos, sistema preparado para dados reais da API ConLicitação
