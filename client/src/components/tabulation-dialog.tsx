...
import { Tags, Save, Plus, BookOpen, X } from "lucide-react";
          ...
          <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
            ...
            <TabsContent value="notes" className="space-y-4 mt-6 overflow-y-auto max-h-96">
              <div className="space-y-4 pb-4">
                ...
                <div>
                  ...
                  <div className="mt-2">
                    ...
                    <div className="mt-3 border-t border-gray-200 pt-3">
                      <div className="flex gap-2">
                        <Input
                          placeholder="Adicionar novo site..."
                          value={newSiteUrl}
                ...
                {/* Fornecedor */}
                <div>
                  <Label className="text-sm font-semibold text-gray-800">Fornecedor Indicado:</Label>
                  <Input
                ...
                {/* Anotações Gerais */}
                <div>
                  <Label className="text-sm font-semibold text-gray-800">Anotações Gerais:</Label>
                  <Textarea
                    placeholder="Suas anotações sobre esta licitação..."
                    value={notes}
                    onChange={(e) => setNotes(e.target.value)}
                    className="mt-1 min-h-24 border-gray-300 focus:border-blue-500 focus:ring-2 focus:ring-blue-200"
                  />
                </div>
              </div>
            </TabsContent>
